...
public class teknologiinformasi extends Fragment {

    private ArrayList<String> dataSet;
    protected Context context;

    public static teknologiinformasi newInstance(){
        return new teknologiinformasi();
    ...
    private void loadData() {
        ...
        switch (nama) {
            case "Abidarin Rosidi, Dr, M.Ma.":
                dataSet.add(String.valueOf(R.drawable.kosong));
                break;
